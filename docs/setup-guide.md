# Setup & Deployment Guide: Threat Intel

> **This file is read by the automated evaluation pipeline and human judges. Follow these steps to run Threat Intel locally or deploy to cloud providers.**
